...
public class SimpleSchemaRegistryClient {
    ...
    public String register(String topicName, String schema) throws IOException, SchemaClientException {
        String path = String.format("/subjects/%s", new Object[]{topicName});
    ...
    public List<SchemaInfo> getSchemaLatestAll() throws IOException, SchemaClientException {
    ...
    public SchemaInfo getSchemaBySubject(String subject) throws IOException, SchemaClientException {
        String path = String.format("/subjects/%s", new Object[]{subject});
        SchemaInfo schemaInfo = httpRequest(path, "GET", null, new HashMap<String, String>(), SCHEMAINFO_TYPE);
        return schemaInfo;
    }

    public SchemaInfo getSchemaBySubjectAndId(String subject, String id) throws IOException, SchemaClientException {
        String path = String.format("/subjects/%s/ids/%s", new Object[]{subject, id});
        SchemaInfo schemaInfo = httpRequest(path, "GET", null, new HashMap<String, String>(), SCHEMAINFO_TYPE);
        return schemaInfo;
    }
