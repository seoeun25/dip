...
import com.nexr.camus.etl.kafka.partitioner.SimpleHourlyPartitioner;
...
public class SimpleHourlyPartitionerTest {

  @Test
  public void testDefaultConfiguration() throws Exception {
    SimpleHourlyPartitioner underTest = new SimpleHourlyPartitioner();
